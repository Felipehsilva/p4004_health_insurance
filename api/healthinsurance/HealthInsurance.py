...
class HealthInsurance:  
    ...
    def __init__(self):
        self.home_path = '/home/felipe/Documents/PA4-Health_Insurance/p4004_health_insurance/'
        self.annual_premium = pickle.load(open(self.home_path + 'features/annual_premium.pkl','rb'))
    ...
    def get_prediction (self,model, original_data, test_data):
        ...
        original_data['prediction'] = pred[0,0]
